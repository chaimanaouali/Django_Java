    ...
    void insertOne(ActionEvent event) {
        if (tfNom.getText().isEmpty() || tfPrenom.getText().isEmpty() || tfAdresse.getText().isEmpty() ||
            ...
            try {
                ...
                Path source = Paths.get("path/to/your/source/file.txt"); // Source path of your file
                ...
                showNotification("Success", "Données insérées avec succès!");
                ...
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Erreur de copie de fichier");
                alert.setContentText("Une erreur s'est produite lors de la copie du fichier!");
                alert.show();
            }
        }
    }
