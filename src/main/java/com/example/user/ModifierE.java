...
public class ModifierE {
    ...
    public void initialize() throws SQLException {
        ...
        try {
            cnx = DriverManager.getConnection("jdbc:mysql://localhost:3306/integration", "root", "");
    ...
    private String getNomFromIDMecanicin(Connection cnx, int mecId) throws SQLException {
        String nom = null;
        try (PreparedStatement preparedStatement = cnx.prepareStatement("SELECT nom FROM mecanicien WHERE id = ?")) {
    ...
    public void setEvaluationToModify(evaluation E) {
        ...
        if (E != null) {
            ...
            try {
                ...
                String nomMec = getNomFromIDMecanicin(cnx, mecId);
    ...
    void btnmodifierE(ActionEvent event) {
        ...
        try (Connection cnx = DriverManager.getConnection("jdbc:mysql://localhost:3306/integration", "root", "")) {
            int idEvaluation = Integer.parseInt(ide.getText());
            String nomMec = comboboxmec.getValue();
            int mecId = getIDFromNomMecanicin(cnx, nomMec);
