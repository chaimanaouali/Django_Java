...
public class itemPost {
    ...
    public static final String ACCOUNT_SID = "AC07d93d312fcd48c72f46785733c0aef0";
    public static final String AUTH_TOKEN = "260933083dcce41737a79101d605451a";
   ...
   // private MyListener myListener;
    ...
    public static void sendSMS(String recipientPhoneNumber, String messageBody) {
        String twilioPhoneNumber = "+12512201215";
    ...
    private void sendSMS(ActionEvent event) {
        String recipientPhoneNumber = "+21626455505";
    ...
    private void showSharePopup(MouseEvent event) {
        ...
        ImageView gmailIcon = new ImageView(new Image(getClass().getResourceAsStream("/images/gmail.png")));
