...
public class ServiceTraitement implements IService<traitement> {
    ...
    public void create(traitement traitement) throws SQLException {
        String request = "INSERT INTO traitement (id, date_taitement, statut, remarque, responsable) VALUES (?, ?, ?, ?, ?)";
        ...
        preparedStatement.setInt(1, traitement.getIdT());
        preparedStatement.setObject(2, traitement.getDate_traitement());
        preparedStatement.setString(3, traitement.getStatut());
        preparedStatement.setString(4, traitement.getRemarque());
        preparedStatement.setString(5, traitement.getResponsable());
    ...
    public void delete(traitement t) throws SQLException, RelatedRecordsException {
        try {
            ...
            preparedStatement.setInt(1, t.getIdT());
            preparedStatement.executeUpdate();
    ...
    public void update(traitement traitement) throws SQLException {
        ...
        pre.setInt(5, traitement.getIdT());
        pre.executeUpdate();
    }
}
